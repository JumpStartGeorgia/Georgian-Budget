...
RSpec.describe 'Budget Items API V1' do
  ...
  describe 'GET /priorities' do
    let!(:priority1) { create(:priority).add_name(attributes_for(:name)) }
    let!(:priority2) { create(:priority).add_name(attributes_for(:name)) }
    let!(:priority3) { create(:priority).add_name(attributes_for(:name)) }
    let!(:program) { create(:program) }
  ...
  describe 'GET /budget_items/:id' do
    context 'when requesting details for an agency' do
      ...
      before do
        ...
        get "/en/v1/budget_items/#{agency1.perma_id}",
            params: {
    ...
    context 'when requesting total budget' do
      ...
      before do
        get "/en/v1/budget_items/#{overall_budget.perma_id}",
            params: {
    ...
    context 'when requesting subprogram with child programs' do
      ...
      before do
        get "/en/v1/budget_items/#{program.perma_id}",
            params: {
              budgetItemFields: 'id,relatedBudgetItems',
